...
const SearchRecipeIcon = ({recipe, selectRecipe, className}) => {
      ...
      <>
        ...
        <div className='recipe-icon__bottom'>
          ...
          <div className='reicpe-icon__row'>
            <FontAwesomeIcon icon={faCirclePlus} className='addicon' onClick={(e) => selectRecipe(recipe)}/>
            {saved
              ? <img src="/icons/savedBookmark.svg" alt="savedbookmark" className='bookmarkicon' onClick={unsaveRecipeClicked}/> 
              : <img src="/icons/unsavedBookmark.svg" alt="unsavedbookmark" className='bookmarkicon' onClick={saveRecipeClicked}/> 
            }
          </div>
        </div>
      </>
...
export default SearchRecipeIcon